...
export default function ContentView({ apostila, id }: ClientViewProps) {
  ...
  return (
    <>
      ...
      <main className="flex h-full w-full flex-col min-h-[100vh]">
        ...
        {/* Contéudo */}
        <div className="flex-1 my-0 mx-auto flex w-full flex-col pb-[5rem] md:px-[3rem] max-w-[2000px]">
            <div className="flex flex-col md:flex-row">
              {/* Only show side nav in telas médias ou maiores */}
